...
# Search rhel8/postgresql-16:1-1752582967 - all arches
mirror_registry_image REG_SEARCH_PG_RHEL8_URL REG_SEARCH_PG_RHEL8_AMD_DIGEST REG_SEARCH_PG_RHEL8_VERSION REG_SEARCH_PG_RHEL8_DEST $AUTHFILE
mirror_registry_image REG_SEARCH_PG_RHEL8_URL REG_SEARCH_PG_RHEL8_ARM_DIGEST REG_SEARCH_PG_RHEL8_VERSION REG_SEARCH_PG_RHEL8_DEST $AUTHFILE
mirror_registry_image REG_SEARCH_PG_RHEL8_URL REG_SEARCH_PG_RHEL8_PPC_DIGEST REG_SEARCH_PG_RHEL8_VERSION REG_SEARCH_PG_RHEL8_DEST $AUTHFILE
mirror_registry_image REG_SEARCH_PG_RHEL8_URL REG_SEARCH_PG_RHEL8_S390X_DIGEST REG_SEARCH_PG_RHEL8_VERSION REG_SEARCH_PG_RHEL8_DEST $AUTHFILE
